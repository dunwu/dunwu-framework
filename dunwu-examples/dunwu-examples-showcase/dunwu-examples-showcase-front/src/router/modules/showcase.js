...
const filesystemRouter = {
  ...
  meta: { title: '文件服务' },
  children: [{
    path: 'list', component: () => import('@/views/showcase/filesystem/list'), name: 'list', meta: { title: '文件列表' }
  }, {
...
const schedulerRouter = {
  ...
  meta: { title: '调度服务' },
  children: [{
    path: 'list', component: () => import('@/views/showcase/scheduler/list'), name: 'list', meta: { title: '任务列表' }
  }, {
...
const templateRouter = {
  ...
  meta: { title: '模板服务' },
  children: [{
    path: 'list', component: () => import('@/views/showcase/template/list'), name: 'list', meta: { title: '模板列表' }
  }, {
...
const generateIdRouter = {
  path: 'id', component: () => import('@/views/showcase/generate-id'), name: 'generate-id', meta: { title: '分布式ID' }
}
