...
public class TemplateController {
	...
	public DataResult<String> save(@RequestBody TemplateConfig entity) {
		return service.save(entity);
	}

	@PostMapping("saveBatch")
	@ApiOperation(value = "批量添加 TemplateConfig 记录（选择字段，策略插入）")
	public BaseResult saveBatch(@RequestBody Collection<TemplateConfig> entityList) {
	...
	public BaseResult update(@RequestBody TemplateConfig target,
			@RequestParam TemplateConfig origin) {
		return service.update(target, origin);
	}

	@PostMapping("updateBatchById")
	@ApiOperation(value = "根据 ID 批量修改 TemplateConfig 记录")
	public BaseResult updateBatchById(
			@RequestBody Collection<TemplateConfig> entityList) {
	...
	public BaseResult saveOrUpdateBatch(
			@RequestBody Collection<TemplateConfig> entityList) {
	...
	public DataListResult<TemplateConfig> listByIds(
			@RequestParam Collection<String> idList) {
	...
	public PageResult<TemplateConfig> page(Pagination<TemplateConfig> pagination,
			TemplateConfig entity) {
