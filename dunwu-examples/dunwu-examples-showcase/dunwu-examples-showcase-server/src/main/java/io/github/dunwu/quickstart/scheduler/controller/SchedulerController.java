...
public class SchedulerController {
	...
	public DataResult<String> save(@RequestBody SchedulerInfo entity) {
		return schedulerInfoService.save(entity);
	}

	@PostMapping("saveBatch")
	@ApiOperation(value = "批量添加 SchedulerInfo 记录（选择字段，策略插入）")
	public BaseResult saveBatch(@RequestBody Collection<SchedulerInfo> entityList) {
	...
	public BaseResult remove(@RequestBody SchedulerInfo entity) {
	...
	public BaseResult updateById(@RequestBody SchedulerInfo entity) {
	...
	public BaseResult updateBatchById(@RequestBody Collection<SchedulerInfo> entityList) {
		return schedulerInfoService.updateBatchById(entityList);
	}

	@PostMapping("saveOrUpdate")
	@ApiOperation(value = "ID 存在则更新记录，否则插入一条记录")
	public BaseResult saveOrUpdate(@RequestBody SchedulerInfo entity) {
	...
	public BaseResult saveOrUpdateBatch(
			@RequestBody Collection<SchedulerInfo> entityList) {
