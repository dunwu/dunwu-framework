 ...
 * <p>
 * 文件将被存储在 FastDFS 中的
 * {@link io.github.dunwu.quickstart.fs.config.FileSystemProperties.Fdfs#group}
 *
...
public class FdfsFileStorageServiceImpl extends BaseFileStorageService
	...
	public FileDTO create(UploadFileDTO uploadFileDTO) throws IOException {
		...
		StorePath path = storageClient.uploadFile(
				fileSystemProperties.getFdfs().getGroup(),
				uploadFileDTO.getFile().getInputStream(), fileDTO.getSize(),
