package io.github.dunwu.admin.mail.service.impl;

import io.github.dunwu.autoconfigure.mail.DunwuMailProperties;
import io.github.dunwu.admin.mail.dto.MailDTO;
import io.github.dunwu.admin.mail.service.MailService;
...
public class MailServiceImpl implements MailService {
    ...
    private void sendSimpleMessage(List<MailDTO> mailDTOS) {
        if (CollectionUtil.isEmpty(mailDTOS)) {
            return;
        }

        List<SimpleMailMessage> simpleMailMessages = BeanUtil.toBeanList(mailDTOS, SimpleMailMessage.class);
