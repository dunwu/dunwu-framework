...
INSERT INTO t_user (username, password, sex, avatar, email, mobile, status)
...
INSERT INTO t_role(code, name, status, notes)
...
INSERT INTO t_menu (id, parent_id, url, name, perms, icon, type, power, status, notes)
...
-- 初始化 t_menu
INSERT INTO t_permission (id, name, expression, type, status, notes)
