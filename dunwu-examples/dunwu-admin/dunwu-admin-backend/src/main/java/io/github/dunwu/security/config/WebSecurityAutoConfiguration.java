package io.github.dunwu.security.config;

import io.github.dunwu.security.service.AuthService;
import io.github.dunwu.system.filter.DunwuAuthenticationFilter;
import io.github.dunwu.system.handler.*;
import io.github.dunwu.system.handler.*;
...
public class WebSecurityAutoConfiguration extends WebSecurityConfigurerAdapter {
    ...
    public PersistentTokenBasedRememberMeServices rememberMeServices() {
        PersistentTokenBasedRememberMeServices rememberMeServices =
            new PersistentTokenBasedRememberMeServices("rememberme", authService, persistentTokenRepository());
