  ...
  <div class="app-container">
    ...
    >
      <el-form-item label="任务组" prop="jobGroup" class="upload-form-item">
        <el-input v-model="schedulerForm.jobGroup" />
      </el-form-item>
      <el-form-item label="任务名" prop="jobName" class="upload-form-item">
        <el-input v-model="schedulerForm.jobName" />
      </el-form-item>
      <el-form-item
        label="触发类型"
        prop="triggerType"
      ...
      <el-form-item
        ...
        class="upload-form-item"
      >
        <el-input v-model="schedulerForm.repeatInterval" />
      </el-form-item>
      <el-form-item
        v-if="0 === schedulerForm.triggerType.valueOf()"
        label="重复触发次数"
        ...
        class="upload-form-item"
      >
        <el-input v-model="schedulerForm.repeatCount" />
      </el-form-item>
      <el-form-item
        ...
        class="upload-form-item"
      >
        <el-input v-model="schedulerForm.cronExpression" />
      </el-form-item>
