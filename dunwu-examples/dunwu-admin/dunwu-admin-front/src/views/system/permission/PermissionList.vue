<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column prop="expression" label="权限表达式" />
...
<script>
import { getPermissionPage, deletePermissionById } from '@/api/system/permission'
...
export default {
  ...
  methods: {
    ...
    openUpdatePage(row) {
      this.$router.push({
        path: `/system/permission/update?id=${row.id}`
      })
    },
