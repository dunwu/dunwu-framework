...
const generateIdRouter = {
  path: 'id', component: () => import('@/views/showcase/generate-id'), name: 'GenerateId', meta: { title: '分布式ID' }
}

const ipRegionRouter = {
  path: 'ip', component: () => import('@/views/showcase/ip-region'), name: 'IpRegion', meta: { title: 'IP所在地' }
}
