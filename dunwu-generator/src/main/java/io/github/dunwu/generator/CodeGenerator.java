...
public class CodeGenerator {
    ...
    public static void main(String... args) {
        ...
        gc.setOpen(false).setFileOverride(true).setActiveRecord(false).setOutputDir(javaDir)
            .setAuthor("<a href=\"mailto:forbreak@163.com\">Zhang Peng</a>").setMapperName("%sDao").setXmlName("%sDao")
        ...
        sc.setEntityLombokModel(true).setControllerMappingHyphenStyle(true).setRestControllerStyle(true)
            ...
            .setSuperEntityClass("io.github.dunwu.data.entity.BaseSwaggerEntity")
