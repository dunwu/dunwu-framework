...
public interface CodeGeneratorProperties {
    enum ParamKeyEnum {
        ...
        MYBATIS_GENERATOR_GC_SERVICE_NAME("mybatis.generator.gc.service-name", "%sDao"),
        MYBATIS_GENERATOR_GC_SERVICE_IMPL_NAME("mybatis.generator.gc.service-impl-name", "%sDaoImpl"),
        ...
        MYBATIS_GENERATOR_SC_SUPER_SERVICE("mybatis.generator.sc.super.service", "io.github.dunwu.data.dao.IDao"),
        MYBATIS_GENERATOR_SC_SUPER_SERVICE_IMPL("mybatis.generator.sc.super.service.impl", "io.github.dunwu.data.dao.BaseDao"),
