...
public abstract class BaseExtDaoImpl<M extends BaseMapper<E>, E> extends DaoImpl<M, E>
    ...
    @Override
    public org.springframework.data.domain.Page<E> springPage(Pageable pageable, QueryWrapper<E> wrapper) {
    ...
    @Override
    public org.springframework.data.domain.Page<E> pageByQuery(Object query, Pageable pageable) {
