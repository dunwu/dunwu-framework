...
public DataResult
<Integer> save(@RequestBody ${entity} entity) {
  ...
  <#if swagger2>
    @ApiOperation(value = "根据 columnMap 条件，删除 ${entity} 记录")
          ...
          public BaseResult removeByMap(@RequestBody Map
  <String
      , Object> columnMap) {
    ...
    <#if swagger2>
      @ApiOperation(value = "根据 ID 批量删除 ${entity} 记录")
                ...
                public BaseResult removeByIds(@RequestBody Collection
    <String> idList) {
      ...
      <#if swagger2>
        @ApiOperation(value = "根据 ID 批量查询 ${entity} 记录")
             ...
             public DataListResult<${entity}> listByIds(@RequestParam Collection
      <String> idList) {
        ...
        <#if swagger2>
          @ApiOperation(value = "根据 columnMap 批量查询 ${entity} 记录")
               ...
               public DataListResult<${entity}> listByMap(Map
        <String
            , Object> columnMap) {
