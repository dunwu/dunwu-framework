...
import io.github.dunwu.util.concurrent.ThreadUtil;
...
public class ThreadPoolUtilTest {
    ...
    @Test
    public void fixPool() {
        ThreadPoolExecutor singlePool = ThreadPoolUtil.fixedPool().build();
        ...
        ThreadPoolExecutor fixPoolWithNamePrefix =
            ThreadPoolUtil.fixedPool().setPoolSize(10).setThreadNamePrefix("fixPool").build();
        ...
        ThreadPoolExecutor fixPoolWithNamePrefixAndDaemon =
            ThreadPoolUtil.fixedPool().setPoolSize(10).setThreadNamePrefix("fixPoolDaemon").setDaemon(true).build();
    ...
    public void cachedPool() {
        ...
        ThreadPoolExecutor sizeablePool =
            ThreadPoolUtil.cachedPool().setMinSize(10).setMaxSize(100).setKeepAliveSecs(20).build();
        ...
        ThreadPoolExecutor fixPoolWithNamePrefix =
            ThreadPoolUtil.cachedPool().setThreadNamePrefix("cachedPool").build();
    ...
    public void scheduledPool() {
        ...
        ThreadPoolExecutor fixPoolWithNamePrefix =
            ThreadPoolUtil.scheduledPool().setThreadNamePrefix("scheduledPool").build();
        Thread thread = fixPoolWithNamePrefix.getThreadFactory().newThread(new Runnable() {
            @Override
            public void run() {
            }
    ...
    public void quequablePool() {
        ...
        ThreadPoolExecutor sizeablePool =
            ThreadPoolUtil.queuableCachedPool().setMinSize(10).setMaxSize(100).setKeepAliveSecs(20).build();
        assertThat(sizeablePool.getCorePoolSize()).isEqualTo(10);
        assertThat(sizeablePool.getMaximumPoolSize()).isEqualTo(100);
        assertThat(sizeablePool.getKeepAliveTime(TimeUnit.SECONDS)).isEqualTo(20);
        sizeablePool.shutdown();
        ...
        ThreadPoolExecutor fixPoolWithNamePrefix =
            ThreadPoolUtil.queuableCachedPool().setThreadNamePrefix("queuableCachedPool").build();
        Thread thread = fixPoolWithNamePrefix.getThreadFactory().newThread(new Runnable() {
