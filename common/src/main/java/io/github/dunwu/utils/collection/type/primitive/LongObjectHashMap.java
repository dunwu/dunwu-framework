 ...
 */
package io.github.dunwu.utils.collection.type.primitive;
...
import io.github.dunwu.utils.number.MathUtil;
...
public class LongObjectHashMap<V> implements LongObjectMap<V> {
    ...
    public LongObjectHashMap(int initialCapacity, float loadFactor) {
        ...
        @SuppressWarnings({"unchecked", "SuspiciousArrayCast"}) V[] temp = (V[]) new Object[capacity];
        values = temp;
    ...
    public void putAll(Map<? extends Long, ? extends V> sourceMap) {
        if (sourceMap instanceof LongObjectHashMap) {
            ...
            @SuppressWarnings("unchecked") LongObjectHashMap<V> source = (LongObjectHashMap<V>) sourceMap;
    ...
    public boolean containsValue(Object value) {
        @SuppressWarnings("unchecked") V v1 = toInternal((V) value);
        for (V v2 : values) {
    ...
    public boolean equals(Object obj) {
        ...
        @SuppressWarnings("rawtypes") LongObjectMap other = (LongObjectMap) obj;
        if (size != other.size()) {
            return false;
        }
    ...
    private void rehash(int newCapacity) {
        ...
        @SuppressWarnings({"unchecked", "SuspiciousArrayCast"}) V[] temp = (V[]) new Object[newCapacity];
        values = temp;
