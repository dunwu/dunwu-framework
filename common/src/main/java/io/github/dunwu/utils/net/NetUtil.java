package io.github.dunwu.utils.net;
...
import io.github.dunwu.utils.collection.MapUtil;
import org.slf4j.Logger;
import org.slf4j.LoggerFactory;
import io.github.dunwu.utils.base.Platforms;
import io.github.dunwu.utils.base.SystemPropertiesUtil;
...
public class NetUtil {
    ...
    private static class LocalAddress {
        ...
        private static InetAddress findLocalAddressViaNetworkInterface() {
            ...
            String preferNamePrefix =
                SystemPropertiesUtil.getString("localhost.prefer.nic.prefix", "LOCALHOST_PREFER_NIC_PREFIX", "bond0.");
            // 如果hostname +/etc/hosts 得到的是127.0.0.1, 和首选网卡都不符合要求，则按顺序遍历下面的网卡
            String defaultNicList = SystemPropertiesUtil
        ...
        do {
            if (++searchCounter > portRange) {
                throw new IllegalStateException(String
                    .format("Could not find an available tcp port in the range [%d, %d] after %d attempts", minPort,
