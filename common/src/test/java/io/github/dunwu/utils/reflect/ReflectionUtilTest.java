...
public class ReflectionUtilTest {
    ...
    public void invokeMethod() {
        ...
        //        // 使用函数名+参数类型的匹配
        //        assertThat(
        //            ReflectionUtil.invokeMethod(bean, "privateMethod", new Object[] {"calvin"}, new Class[] {String
        // .class}))
        //            .isEqualTo("hello calvin");
        //
        //        // 仅匹配函数名
        ...
        //            .isEqualTo(1);
        //
        //        assertThat(ReflectionUtil.invokeMethod(bean, "integerType", new Object[] {1}, new Class[] {Integer
        // .class}))
        //            .isEqualTo(1);
        //
        //        assertThat(ReflectionUtil
        //            .invokeMethod(bean, "listType", new Object[] {ListUtil.newArrayList("1", "2")}, new Class[]
        // {List.class}))
        //            .isEqualTo(2);
        //
        ...
        //
        //        assertThat(ReflectionUtil.invokeMethod(bean, "listType", ListUtil.newArrayList("1", "2")))
        // .isEqualTo(2);
        //
        //        // 函数名错
        //        try {
        //            ReflectionUtil.invokeMethod(bean, "notExistMethod", new Object[] {"calvin"}, new Class[]
        // {String.class});
        //            failBecauseExceptionWasNotThrown(IllegalArgumentException.class);
        ...
        //        // 参数类型错
        //        try {
        //            ReflectionUtil.invokeMethod(bean, "privateMethod", new Object[] {"calvin"}, new Class[]
        // {Integer.class});
