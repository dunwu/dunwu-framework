...
public class ClassUtilTest {
    ...
    public void classPresent() {
        ...
        assertThat(ClassLoaderUtil
            .isPresent("io.github.dunwu.utils.reflect.ClassUtil", ClassLoaderUtil.getDefaultClassLoader())).isTrue();
    }

    /**
     * Unit test case of {@link io.github.dunwu.utils.reflect.ClassUtil#isSubClassOrInterfaceOf(Class, Class)}
     */
    @Test
