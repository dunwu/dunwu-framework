package io.github.dunwu.utils.concurrent.threadpool;
...
import io.github.dunwu.utils.concurrent.threadpool.QueuableCachedThreadPool.ControllableQueue;
...
public class ThreadPoolBuilderTest {
    ...
    public void fixPool() {
        ...
        ThreadPoolExecutor fixPoolWithNamePrefix =
            ThreadPoolBuilder.fixedPool().setPoolSize(10).setThreadNamePrefix("fixPool").build();
        ...
        ThreadPoolExecutor fixPoolWithNamePrefixAndDaemon =
            ThreadPoolBuilder.fixedPool().setPoolSize(10).setThreadNamePrefix("fixPoolDaemon").setDaemon(true).build();
    ...
    public void cachedPool() {
        ...
        ThreadPoolExecutor sizeablePool =
            ThreadPoolBuilder.cachedPool().setMinSize(10).setMaxSize(100).setKeepAliveSecs(20).build();
        ...
        ThreadPoolExecutor fixPoolWithNamePrefix =
            ThreadPoolBuilder.cachedPool().setThreadNamePrefix("cachedPool").build();
    ...
    public void scheduledPool() {
        ...
        ThreadPoolExecutor fixPoolWithNamePrefix =
            ThreadPoolBuilder.scheduledPool().setThreadNamePrefix("scheduledPool").build();
        Thread thread = fixPoolWithNamePrefix.getThreadFactory().newThread(new Runnable() {
            @Override
            public void run() {
            }
    ...
    public void quequablePool() {
        ...
        ThreadPoolExecutor sizeablePool =
            ThreadPoolBuilder.queuableCachedPool().setMinSize(10).setMaxSize(100).setKeepAliveSecs(20).build();
        assertThat(sizeablePool.getCorePoolSize()).isEqualTo(10);
        assertThat(sizeablePool.getMaximumPoolSize()).isEqualTo(100);
        assertThat(sizeablePool.getKeepAliveTime(TimeUnit.SECONDS)).isEqualTo(20);
        sizeablePool.shutdown();
        ...
        ThreadPoolExecutor fixPoolWithNamePrefix =
            ThreadPoolBuilder.queuableCachedPool().setThreadNamePrefix("queuableCachedPool").build();
        Thread thread = fixPoolWithNamePrefix.getThreadFactory().newThread(new Runnable() {
