...
public class ObjectUtilTest {
	...
	public void hashCodeTest() {
		assertThat(ObjectUtil.hashCode("a", "b") - ObjectUtil.hashCode("a", "a"))
				.isEqualTo(1);
	}
	...
	public void toPrettyString() {
		...
		assertThat(ObjectUtil.toPrettyString(new double[] { 1.1d, 2.2d }))
				.isEqualTo("[1.1, 2.2]");
		assertThat(ObjectUtil.toPrettyString(new float[] { 1.1f, 2.2f }))
				.isEqualTo("[1.1, 2.2]");
		assertThat(ObjectUtil.toPrettyString(new boolean[] { true, false }))
		...
		assertThat(ObjectUtil.toPrettyString(ListUtil.newArrayList("1", "2")))
				.isEqualTo("{1,2}");
