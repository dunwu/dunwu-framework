...
/**
 * Date的parse()与format(), 采用Apache Common Lang中线程安全, 性能更佳的FastDateFormat 注意Common
 * Lang版本，3.5版才使用StringBuilder，3 .4及以前使用StringBuffer. 1. 常用格式的FastDateFormat定义,
 * 常用格式直接使用这些FastDateFormat 2. 日期格式不固定时的String<->Date 转换函数. 3.
...
public class DateFormatUtil {
	...
	public enum DatePattern {
		...
		// 以空格分隔日期和时间，不带时区信息
		PATTERN_DEFAULT("yyyy-MM-dd HH:mm:ss.SSS"), PATTERN_DEFAULT_ON_SECOND("yyyy-MM-dd HH:mm:ss");
