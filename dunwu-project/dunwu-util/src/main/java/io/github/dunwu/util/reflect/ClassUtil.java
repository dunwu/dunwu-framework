...
public class ClassUtil {
	...
	/**
	 * 返回短Class名, 不包含PackageName. 内部类的话，返回"主类.内部类"
	 */
	...
	/**
	 * https://github.com/linkedin/linkedin-utils/blob/master/org.linkedin
	 * .util-core/src/main/java/org/linkedin/util/reflect/ReflectUtils.java The purpose of
	 * this method is somewhat to provide a better naming / documentation than the javadoc
	 * of <code>Class.isAssignableFrom</code> method.
	...
	/**
	 * 通过反射, 获得Class定义中声明的泛型参数的类型, 注意泛型必须定义在父类处. 这是唯一可以通过反射从泛型获得Class实例的地方. 如无法找到,
	 ...
	 * 返回Object.class. 如public UserDao extends HibernateDao<User,Long>
