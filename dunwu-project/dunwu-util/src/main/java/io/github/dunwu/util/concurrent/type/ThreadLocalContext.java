package io.github.dunwu.util.concurrent.type;

import java.util.HashMap;
import java.util.Map;

/**
 * 存储于ThreadLocal的Map, 用于存储上下文.<br/> 但HashMap<String,Object>的存储其实较为低效，在高性能场景下可改为EnumMap<br/> 1.先定义枚举类，列举所有可能的Key<br/>
 * 2.替换contextMap的创建语句，见下例<br/> 3.修改put()/get()中key的类型<br/>
 * <pre>
