...
public class ListUtil {
	...
	/**
	 * 返回包装后同步的List，所有方法都会被synchronized原语同步. 用于CopyOnWriteArrayList与 ArrayDequeue均不符合的场景
	 */
	...
	/**
	 * list1, list2的交集（同时在list1和list2的对象），产生新List copy from Apache Common Collection4
