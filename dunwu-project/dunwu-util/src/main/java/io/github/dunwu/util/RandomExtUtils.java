...
public class RandomExtUtils extends RandomUtils {
	...
	public static String randomString(final Random random, final int min, final int max) {
		return RandomStringUtils.random(nextInt(random, min, max), 0, 0, true,
			true, null, random);
	}
	...
	public static String randomAscii(Random random, final int min, final int max) {
		return RandomStringUtils.random(nextInt(random, min, max), 32, 127,
	...
	public static String randomDate(final Date min, final Date max, String pattern) {
		return randomDate(DateUtil.date2LocalDateTime(min), DateUtil.date2LocalDateTime(max),
			pattern);
	}
