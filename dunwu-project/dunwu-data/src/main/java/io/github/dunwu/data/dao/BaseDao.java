 ...
 * @since 2018-06-23
 */
public class BaseDao<M extends BaseMapper<T>, T> implements IDao<T> {
	...
	@Override
	public <V> List<V> listObjs(Wrapper<T> queryWrapper,
			Function<? super Object, V> mapper) {
		return baseMapper.selectObjs(queryWrapper).stream().filter(Objects::nonNull)
