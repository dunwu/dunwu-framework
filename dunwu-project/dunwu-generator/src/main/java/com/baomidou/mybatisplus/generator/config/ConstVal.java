...
public interface ConstVal {
	...
	String SUPER_DAO_CLASS = "io.github.dunwu.data.dao.IDao";

	String SUPER_DAO_IMPL_CLASS = "io.github.dunwu.data.dao.BaseDao";

	String SUPER_SERVICE_CLASS = "io.github.dunwu.data.service.IService";

	String SUPER_SERVICE_IMPL_CLASS = "io.github.dunwu.data.service.BaseService";
