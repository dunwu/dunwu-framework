    ...
    protected ConfigBuilder pretreatmentConfigBuilder(ConfigBuilder config) {
        ...
        for (TableInfo tableInfo : tableList) {
            ...
            if (config.getStrategyConfig()
                      .getLogicDeleteFieldName() != null && tableInfo.isLogicDelete(config.getStrategyConfig()
                                                                                          .getLogicDeleteFieldName())) {
                // 逻辑删除注解
                tableInfo.setImportPackages(TableLogic.class.getCanonicalName());
            }
            if (StringUtils.isNotEmpty(config.getStrategyConfig()
                                             .getVersionFieldName())) {
                // 乐观锁注解
            ...
            if (config.getStrategyConfig()
                ...
                tableInfo.getFields()
                         ...
                         .filter(field -> field.getPropertyName()
                                               .startsWith("is"))
                         .forEach(field -> {
