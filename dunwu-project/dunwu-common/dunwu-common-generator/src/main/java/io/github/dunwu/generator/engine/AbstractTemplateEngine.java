        ...
        try {
            ...
            for (TableInfo tableInfo : tableInfoList) {
                ...
                if (null != entityName && null != pathInfo.get(ConstVal.ENTITY_PATH)) {
                    String entityFile =
                        String.format((pathInfo.get(ConstVal.ENTITY_PATH) + File.separator + "%s" + suffixJavaOrKt()),
                            entityName);
                ...
                if (null != dtoName && null != pathInfo.get(ConstVal.DTO_PATH)) {
                    String dtoFile =
                        String.format((pathInfo.get(ConstVal.DTO_PATH) + File.separator + "%s" + suffixJavaOrKt()),
                            dtoName);
                ...
                if (null != queryName && null != pathInfo.get(ConstVal.QUERY_PATH)) {
                    String queryFile =
                        String.format((pathInfo.get(ConstVal.QUERY_PATH) + File.separator + "%s" + suffixJavaOrKt()),
                            queryName);
                ...
                if (null != tableInfo.getMapperName() && null != pathInfo.get(ConstVal.MAPPER_PATH)) {
                    String mapperFile = String.format((pathInfo.get(ConstVal.MAPPER_PATH)
                        + File.separator
                ...
                if (null != tableInfo.getDaoName() && null != pathInfo.get(ConstVal.DAO_PATH)) {
                    String daoFile = String.format((pathInfo.get(ConstVal.DAO_PATH)
                        + File.separator
                ...
                if (null != tableInfo.getDaoImplName() && null != pathInfo.get(ConstVal.DAO_IMPL_PATH)) {
                    String implFile = String.format((pathInfo.get(ConstVal.DAO_IMPL_PATH)
                        + File.separator
                ...
                if (null != tableInfo.getServiceName() && null != pathInfo.get(ConstVal.SERVICE_PATH)) {
                    String serviceFile = String.format((pathInfo.get(ConstVal.SERVICE_PATH)
                        + File.separator
                ...
                if (null != tableInfo.getServiceImplName() && null != pathInfo.get(ConstVal.SERVICE_IMPL_PATH)) {
                    String implFile = String.format((pathInfo.get(ConstVal.SERVICE_IMPL_PATH)
                        + File.separator
                ...
                if (null != tableInfo.getControllerName() && null != pathInfo.get(ConstVal.CONTROLLER_PATH)) {
                    String controllerFile = String.format((pathInfo.get(ConstVal.CONTROLLER_PATH)
                        + File.separator
