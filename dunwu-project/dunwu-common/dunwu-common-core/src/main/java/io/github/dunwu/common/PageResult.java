...
public class PageResult<T> extends BaseResult {
     ...
     *
     * @param data 被分页实体 {@link Pagination} 包装的应答数据对象
     */
    public PageResult(Pagination<T> data) {
     ...
     */
    public static <T> PageResult<T> failDataPage() {
        return failDataPage(ResultStatus.FAIL);
    }
     ...
     * @return {@link PageResult}
     */
    public static <T> PageResult<T> failDataPage(final Status status) {
     ...
     * @return {@link PageResult}
     */
    public static <T> PageResult<T> failDataPage(final int code, final String message) {
     ...
     * @return {@link PageResult}
     */
    public static <T> PageResult<T> failDataPage(final int code, final List<String> messages) {
     ...
     * @return {@link PageResult}
     */
    public static <T> PageResult<T> failDataPage(final int code, final String template, final Object... params) {
     ...
     * @return {@link PageResult}
     */
    public static <T> PageResult<T> success(Pagination<T> data) {
