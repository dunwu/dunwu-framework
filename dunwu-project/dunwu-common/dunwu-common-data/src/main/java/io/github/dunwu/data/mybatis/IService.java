...
public interface IService<T> {
     ...
     */
    PageResult<T> page(QueryRequest<T> query);
     ...
     */
    PageResult<Map<String, Object>> pageMaps(QueryRequest<T> query);
     ...
     * @param entity 实体对象
     */
    DataResult<Integer> insert(T entity);
    ...
    BaseResult insertBatch(Collection<T> entityList, int batchSize);
     ...
     */
    @Transactional(rollbackFor = Exception.class)
    default BaseResult insertBatch(Collection<T> entityList) {
     ...
     */
    BaseResult delete(Wrapper<T> queryWrapper);
     ...
     * @param entity 待删除实体
     */
    default BaseResult delete(T entity) {
        UpdateWrapper<T> updateWrapper = Wrappers.update(entity);
     ...
     */
    @Transactional(rollbackFor = Exception.class)
    BaseResult deleteBatchIds(Collection<? extends Serializable> idList);
     ...
     */
    @Transactional(rollbackFor = Exception.class)
    BaseResult deleteByMap(Map<String, Object> columnMap);
