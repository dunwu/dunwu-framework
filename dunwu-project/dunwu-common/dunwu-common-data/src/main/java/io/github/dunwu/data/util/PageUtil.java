...
public class PageUtil {
    ...
    /**
     * 将页数和每页条目数转换为结束位置<br> 此方法用于不包括结束位置的分页方法<br> 例如：
     *
     * <pre>
     * 页码：0，每页10 =》 9
     * 页码：1，每页10 =》 19
    ...
    /**
     * 将页数和每页条目数转换为开始位置和结束位置<br> 此方法用于包括结束位置的分页方法<br> 例如：
     *
     * <pre>
     * 页码：0，每页10 =》 [0, 10]
     * 页码：1，每页10 =》 [10, 20]
    ...
    /**
     * 分页彩虹算法<br> 来自：https://github.com/iceroot/iceroot/blob/master/src/main/java/com/icexxx/util/IceUtil.java<br>
     * 通过传入的信息，生成一个分页列表显示
     *
     * @param pageNo       当前页
     * @param totalPage    总页数
    ...
    /**
     * 分页彩虹算法(默认展示10页)<br> 来自：https://github.com/iceroot/iceroot/blob/master/src/main/java/com/icexxx/util/IceUtil.java
     *
     ...
     */
    public static <T> Page<T> toSpringPage(int page, int size, List<T> list) {
        return new Pagination<>(list, page, size, list.size());
    }
