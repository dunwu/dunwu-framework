...
class PropertiesUtilTest {
    ...
    void testLoadFromFile() throws IOException {
        Properties properties = PropertiesUtil
            .loadFromFile("classpath://test.properties");
        ...
        assertThat(PropertiesUtil.getString(properties, "dunwu.max", ""))
            .isEqualTo("10");

        assertThat(PropertiesUtil.getBoolean(properties, "dunwu.enabled", false))
            .isTrue();

        assertThat(PropertiesUtil.toList(properties, "dunwu.nodes")).isNotEmpty();
    }
