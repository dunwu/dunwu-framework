...
public class IdcardUtil {
    ...
    public static int getAgeByIdCard(String idCard) {
        return getAgeByIdCard(idCard, DateUtil.toDateTime());
    }
    ...
    public static String convert15To18(String idCard) {
        ...
        if (RegexUtil.matches(idCard, RegexUtil.CITIZEN_ID18)) {
            // 获取出生年月日
            ...
            idCard18 = StringUtil.getStringBuilder().append(idCard, 0, 6).append(sYear).append(idCard.substring(8));
            // 获取校验位
    ...
    public static boolean isValidCard18(String idCard) {
        ...
        //校验生日
        if (!ValidatorUtil.isDate(idCard.substring(6, 14))) {
            return false;
        }
        ...
        if (RegexUtil.matches(code17, RegexUtil.NUMBERS)) {
            // 获取校验位
    ...
    public static boolean isValidCard15(String idCard) {
        ...
        if (RegexUtil.matches(idCard, RegexUtil.NUMBERS)) {
            // 省份
            ...
            //校验生日（两位年份，补充为19XX）
            return false != ValidatorUtil.isDate("19" + idCard.substring(6, 12));
        } else {
            return false;
        }
    }
