...
import io.github.dunwu.tool.io.file.FileWriter;
import io.github.dunwu.tool.io.file.*;
...
public class FileUtil {
    ...
    public static String cleanInvalid(String fileName) {
        return StringUtil.isBlank(fileName) ? fileName : RegexUtil.removeAll(fileName, FILE_NAME_INVALID_PATTERN_WIN);
    }
    ...
    public static boolean containsInvalid(String fileName) {
        return (false == StringUtil.isBlank(fileName)) && RegexUtil.contains(fileName, FILE_NAME_INVALID_PATTERN_WIN);
    }
    ...
    public static File copyFilesFromDir(File src, File dest, boolean isOverride) throws IORuntimeException {
        return FileCopier.create(src, dest)
            .setCopyContentIfDir(true)
            .setOnlyCopyFile(true)
    ...
    /**
     * 可读的文件大小<br> 参考 http://stackoverflow.com/questions/3263892/format-file-size-as-mb-gb-etc
     *
     * @param size Long类型大小
     * @return 大小
     */
