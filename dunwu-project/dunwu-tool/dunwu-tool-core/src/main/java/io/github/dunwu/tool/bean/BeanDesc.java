...
/**
 * Bean信息描述做为BeanInfo替代方案，此对象持有JavaBean中的setters和getters等相关信息描述<br> 查找Getter和Setter方法时会：
 *
 * <pre>
 * 1. 忽略字段和方法名的大小写
...
public class BeanDesc implements Serializable {
    ...
    /**
     * 初始化<br> 只有与属性关联的相关Getter和Setter方法才会被读取，无关的getXXX和setXXX都被忽略
     *
     * @return this
     */
    ...
    /**
     * 根据字段创建属性描述<br> 查找Getter和Setter方法时会：
     *
     * <pre>
     * 1. 忽略字段和方法名的大小写
     * 2. Getter查找getXXX、isXXX、getIsXXX
    ...
    public static class PropDesc {
        ...
        /**
         * 获得字段类型<br> 先获取字段的类型，如果字段不存在，则获取Getter方法的返回类型，否则获取Setter的第一个参数类型
         *
         * @return 字段类型
         */
        ...
        /**
         * 获取字段值<br> 首先调用字段对应的Getter方法获取值，如果Getter方法不存在，则判断字段如果为public，则直接获取字段值
         *
         * @param bean Bean对象
         * @return 字段值
         * @since 4.0.5
        ...
        /**
         * 设置Bean的字段值<br> 首先调用字段对应的Setter方法，如果Setter方法不存在，则判断字段如果为public，则直接赋值字段值
         *
         * @param bean  Bean对象
         * @param value 值
         * @return this
