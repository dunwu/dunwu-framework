...
public class RSA {
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.out.println("公钥：" + Base64.encodeUrlSafe(coder.keyPair.getPublic().getEncoded()));
        System.out.println("私钥：" + Base64.encodeUrlSafe(coder.keyPair.getPrivate().getEncoded()));

        System.out.println("============== 私钥加密，公钥解密 ==============");
        System.out.println("密文：" + Base64.encodeUrlSafe(ciphertext));
        System.out.println("明文：" + new String(plaintext));

        System.out.println("============== 公钥加密，私钥解密 ==============");
        System.out.println("密文：" + Base64.encodeUrlSafe(ciphertext2));
        System.out.println("明文：" + new String(plaintext2));

        System.out.println("============== 数字签名 ==============");
        System.out.println("数字签名：" + Base64.encodeUrlSafe(sign));
