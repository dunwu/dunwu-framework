...
import io.github.dunwu.tool.comparator.VersionComparator;
import io.github.dunwu.tool.convert.Convert;
import io.github.dunwu.tool.lang.Assert;
import io.github.dunwu.tool.lang.Matcher;
...
public class StringUtil {
     ...
     * @return 修改后的字符串
     */
    public static String appendPrefixIfNot(final CharSequence origin, final CharSequence prefix) {
        if (isEmpty(origin) || isEmpty(prefix)) {
            return str(origin);
        }

        final String str2 = origin.toString();
     ...
     * @return 修改后的字符串
     */
    public static String appendSuffixIfNot(final CharSequence origin, final CharSequence suffix) {
        if (isEmpty(origin) || isEmpty(suffix)) {
            return str(origin);
        }
    ...
    /**
     * 给定字符串是否包含空白符（空白符包括空格、制表符、全角空格和不间断空格）<br> 如果给定字符串为null或者""，则返回false
     *
     * @param str 字符串
     * @return 是否包含空白符
     * @since 4.0.8
    ...
    /**
     * 给定字符串是否以任何一个字符串结尾<br> 给定字符串和数组为空都返回false
     *
     * @param str      给定字符串
    ...
    /**
     * 字符串指定位置的字符是否与给定字符相同<br> 如果字符串为null，返回false<br> 如果给定的位置大于字符串长度，返回false<br> 如果给定的位置小于0，返回false
     *
     * @param str      字符串
     * @param position 位置
     * @param c        需要对比的字符
    ...
    /**
     * 将已有字符串填充为规定长度，如果已有字符串超过这个长度则返回这个字符串<br> 字符填充于字符串后
     *
     * @param str        被填充的字符串
     ...
     * 如果经过修正的index中from大于to，则互换from和to example: <br> abcdefgh 2 3 =》 c <br> abcdefgh 2 -3 =》 cde <br>
     *
     * @param str       String
    ...
    /**
     * 如果对象是字符串是否为空白，空白的定义如下： <br> 1、为null <br> 2、为不可见字符（如空格）<br> 3、""<br>
     *
     * @param obj 对象
     * @return 如果为字符串是否为空串
     * @since 3.3.0
    ...
    /**
     * 如果对象是字符串是否为空串空的定义如下:<br> 1、为null <br> 2、为""<br>
     *
     * @param obj 对象
     * @return 如果为字符串是否为空串
     * @since 3.3.0
     ...
     */
    public static <T> String join(CharSequence separator, T... objs) {
        return ArrayUtil.join(separator, objs);
    }
    ...
    /**
     * 指定范围内查找字符串，忽略大小写<br> fromIndex 为搜索起始位置，从后往前计数
     *
     * @param str       字符串
     * @param searchStr 需要查找位置的字符串
    ...
    /**
     * 指定范围内查找字符串<br> fromIndex 为搜索起始位置，从后往前计数
     *
     * @param str        字符串
     * @param searchStr  需要查找位置的字符串
     * @param fromIndex  起始位置，从后往前计数
    ...
    /**
     * 循环位移指定位置的字符串为指定距离<br> 当moveLength大于0向右位移，小于0向左位移，0不位移<br> 当moveLength大于字符串长度时采取循环位移策略，即位移到头后从头（尾）位移，例如长度为10，位移13则表示位移3
     *
     * @param str          字符串
     ...
     *
     * <p>
     * 如果 str=null 或 searchStr=null 或 ordinal&ge;0 则返回-1<br> 此方法来自：Apache-Commons-Lang
     * <p>
     * 例子（*代表任意字符）：
     *
     * <pre>
    ...
    /**
     * 如果给定字符串不是以给定的一个或多个字符串为开头，则在首部添加起始字符串<br> 不忽略大小写
     *
     * @param str      被检查的字符串
    ...
    /**
     * 移除字符串中所有给定字符串<br> 例：removeAll("aa-bb-cc-dd", "-") =》 aabbccdd
     *
     * @param str         字符串
    ...
    public static String removeAll(CharSequence str, char... chars) {
        ...
        final StringBuilder builder = getStringBuilder(len);
        char c;
        for (int i = 0; i < len; i++) {
            c = str.charAt(i);
    ...
    /**
     * 去掉首部指定长度的字符串并将剩余字符串首字母小写<br> 例如：str=setName, prefix=set =》 return name
     *
     * @param str    被处理的字符串
     * @param prefix 前缀
     * @return 处理后的字符串，不符合规范返回null
    ...
    /**
     * 给定字符串是否以任何一个字符串开始<br> 给定字符串和数组为空都返回false
     *
     * @param str      给定字符串
    ...
    /**
     * 截取分隔字符串之后的字符串，不包括分隔字符串<br> 如果给定的字符串为空串（null或""），返回原字符串<br> 如果分隔字符串为空串（null或""），则返回空串，如果分隔字符串未找到，返回空串，举例如下：
     *
     * <pre>
    ...
    /**
     * 截取分隔字符串之前的字符串，不包括分隔字符串<br> 如果给定的字符串为空串（null或""）或者分隔字符串为null，返回原字符串<br> 如果分隔字符串为空串""，则返回空串，如果分隔字符串未找到，返回原字符串，举例如下：
     *
     * <pre>
    ...
    /**
     * 截取分隔字符串之前的字符串，不包括分隔字符串<br> 如果给定的字符串为空串（null或""）或者分隔字符串为null，返回原字符串<br> 如果分隔字符串未找到，返回原字符串，举例如下：
     *
     * <pre>
     * StrUtil.subBefore(null, *)      = null
     * StrUtil.subBefore("", *)        = ""
    ...
    /**
     * 截取字符串,从指定位置开始,截取指定长度的字符串<br> author weibaohui
     *
     * @param input     原始字符串
     * @param fromIndex 开始的index,包括
     * @param length    要截取的长度
    ...
    public static byte[] utf8Bytes(CharSequence str) {
        return toBytes(str, CharsetUtil.CHARSET_UTF_8);
    }

    /**
     * 包装指定字符串<br> 当前缀和后缀一致时使用此方法
     *
     * @param str             被包装的字符串
