...
import io.github.dunwu.tool.lang.copier.SrcToDestCopier;
    ...
    private void internalCopyDirContent(File src, File dest) throws IORuntimeException {
        ...
        if (false == dest.exists()) {
            ...
            throw new IORuntimeException(
                StringUtil.format("Src [{}] is a directory but dest [{}] is a file!", src.getPath(), dest.getPath()));
        }
