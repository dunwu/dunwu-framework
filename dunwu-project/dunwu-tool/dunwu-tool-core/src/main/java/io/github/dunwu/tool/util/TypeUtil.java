...
import io.github.dunwu.tool.map.TableMap;

import java.lang.reflect.*;
import java.util.Map;

/**
 * 针对 {@link Type} 的工具类封装<br> 最主要功能包括：
 *
 * <pre>
...
public class TypeUtil {
    ...
    /**
     * 解析方法的参数类型列表<br> 依赖jre\lib\rt.jar
     *
     * @param method t方法
     * @return 参数类型类列表
    ...
    /**
     * 获取方法的第一个参数类型<br> 优先获取方法的GenericParameterTypes，如果获取不到，则获取ParameterTypes
     *
     * @param method 方法
    ...
    /**
     * 获取方法的参数类型<br> 优先获取方法的GenericParameterTypes，如果获取不到，则获取ParameterTypes
     *
     * @param method 方法
     * @param index  第几个参数的索引，从0开始计数
     * @return {@link Type}，可能为{@code null}
    ...
    /**
     * 获取方法的参数类型列表<br> 优先获取方法的GenericParameterTypes，如果获取不到，则获取ParameterTypes
     *
     * @param method 方法
    ...
    /**
     * 获取方法的返回值类型<br> 获取方法的GenericReturnType
     *
     * @param method 方法
     * @return {@link Type}，可能为{@code null}
     * @see Method#getGenericReturnType()
    ...
    /**
     * 是否未知类型<br> type为null或者{@link TypeVariable} 都视为未知类型
     *
     * @param type Type类型
     * @return 是否未知类型
     * @since 4.5.2
    ...
    /**
     * 将{@link Type} 转换为{@link ParameterizedType}<br> {@link ParameterizedType}用于获取当前类或父类中泛型参数化后的类型<br>
