...
public class NetUtil {
    ...
    /**
     * 查找1024~65535范围内的可用端口<br> 此方法只检测给定范围内的随机一个端口，检测65535-1024次<br> 来自org.springframework.util.SocketUtils
     *
     * @return 可用的端口
     * @since 4.5.4
     */
    ...
    /**
     * 查找指定范围内的可用端口，最大值为65535<br> 此方法只检测给定范围内的随机一个端口，检测65535-minPort次<br> 来自org.springframework.util.SocketUtils
     *
    ...
    /**
     * 获取多个本地可用端口<br> 来自org.springframework.util.SocketUtils
     *
    ...
    public static String longToIpv4(long longIP) {
        final StringBuilder sb = StringUtil.getStringBuilder();
        // 直接右移24位
        sb.append((longIP >>> 24));
        sb.append(".");
        // 将高8位置0，然后右移16位
    ...
    public static String hideIpPart(String ip) {
        return StringUtil.getStringBuilder(ip.length()).append(ip, 0, ip.lastIndexOf(".") + 1).append("*").toString();
    }
    ...
    public static boolean isInRange(String ip, String cidr) {
        ...
        int cidrIpAddr =
            (Integer.parseInt(cidrIps[0]) << 24) | (Integer.parseInt(cidrIps[1]) << 16) | (Integer.parseInt(cidrIps[2])
                << 8) | Integer.parseInt(cidrIps[3]);
    ...
    /**
     * 获得本机的IP地址列表（包括Ipv4和Ipv6）<br> 返回的IP列表有序，按照系统设备顺序
     *
    ...
    /**
     * 获得本机的IPv6地址列表<br> 返回的IP列表有序，按照系统设备顺序
     *
     * @return IP地址列表 {@link LinkedHashSet}
     * @since 4.5.17
     */
