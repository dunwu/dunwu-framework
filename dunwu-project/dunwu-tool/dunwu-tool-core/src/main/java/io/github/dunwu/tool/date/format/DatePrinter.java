...
/**
 * 日期格式化输出接口<br> Thanks to Apache Commons Lang 3.5
 *
 * @author Looly
 * @since 2.16.2
 */
public interface DatePrinter extends DateBasic {
     ...
     * </p>
     * The TimeZone set on the Calendar is only used to adjust the time offset. The TimeZone specified during the
