...
/**
 * 比较器链。此链包装了多个比较器，最终比较结果按照比较器顺序综合多个比较器结果。<br> 按照比较器链的顺序分别比较，如果比较出相等则转向下一个比较器，否则直接返回<br> 此类copy from
...
public class ComparatorChain<E> implements Chain<Comparator<E>, ComparatorChain<E>>, Comparator<E>, Serializable {
    ...
    /**
     * 构造，使用已有的比较器列表和对应的BitSet<br> BitSet中的boolean值需与list中的{@link Comparator}一一对应，true表示正序，false反序
     *
