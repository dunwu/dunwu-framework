 ...
 * the book <a href="http://www.oracle.com/technetwork/java/effectivejava-136174.html">Effective Java</a> by Joshua
 * Bloch. Writing a good <code>hashCode</code> method is actually quite difficult. This class aims to simplify the
 * process.
 * </p>
 *
 * <p>
...
public class HashCodeBuilder implements Builder<Integer> {
    ...
    /**
     * <p>
     * Two randomly chosen, odd numbers must be passed in. Ideally these should be different for each class, however
     * this is not vital.
     * </p>
     *
     * <p>
     ...
     *
     * <p>
     * Static fields will not be tested. Superclass fields will be included. If no fields are found to include in the
     * hash code, the result of this method will be constant.
     * </p>
     *
     * @param object         the Object to create a <code>hashCode</code> for
     * @param testTransients whether to include transient fields
     ...
     * toHashCode() and the unlikeliness of it mattering what the hashCode for HashCodeBuilder itself is.</p>
     *
     * @return <code>hashCode</code> based on the fields appended
     * @since 2.5
     */
