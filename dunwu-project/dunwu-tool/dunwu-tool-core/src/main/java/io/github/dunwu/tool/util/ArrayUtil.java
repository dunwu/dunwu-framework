...
public class ArrayUtil {
    ...
    /**
     * 去重数组中的元素，去重后生成新的数组，原数组不变<br> 此方法通过{@link LinkedHashSet} 去重
     *
     * @param <T>   数组元素类型
     * @param array 数组
     * @return 去重后的数组
    ...
    /**
     * 获取数组对象中指定index的值，支持负数，例如-1表示倒数第一个值<br> 如果数组下标越界，返回null
     *
     * @param <T>   数组元素类型
     * @param array 数组对象
     * @param index 下标，支持负数
     ...
     * @return 连接后的字符串
     */
    public static <T> String join(final CharSequence separator, final T... array) {
        return join(separator, null, null, array);
    }
     ...
     * @since 4.0.10
     */
    public static <T> String join(final CharSequence separator, String prefix, String suffix, final T... array) {
        if (null == array) {
            return null;
        }
        ...
        for (T item : array) {
            ...
            if (ArrayUtil.isArray(item)) {
                sb.append(join(separator, prefix, suffix, ArrayUtil.boxing(item)));
            } else if (item instanceof Iterable<?>) {
                sb.append(IterUtil.join((Iterable<?>) item, separator, prefix, suffix));
            } else if (item instanceof Iterator<?>) {
                sb.append(IterUtil.join((Iterator<?>) item, separator, prefix, suffix));
            } else {
     ...
     * @return 连接后的字符串
     */
    public static String join(CharSequence conjunction, long... array) {
        if (null == array) {
            return null;
        }
     ...
     * @return 连接后的字符串
     */
    public static String join(CharSequence conjunction, int... array) {
        if (null == array) {
            return null;
        }
     ...
     * @return 连接后的字符串
     */
    public static String join(CharSequence conjunction, short... array) {
        if (null == array) {
            return null;
        }
     ...
     * @return 连接后的字符串
     */
    public static String join(CharSequence conjunction, char... array) {
        if (null == array) {
            return null;
        }
     ...
     * @return 连接后的字符串
     */
    public static String join(CharSequence conjunction, byte... array) {
        if (null == array) {
            return null;
        }
     ...
     * @return 连接后的字符串
     */
    public static String join(CharSequence conjunction, boolean... array) {
        if (null == array) {
            return null;
        }
        ...
        if (isArray(array)) {
            ...
            if (componentType.isPrimitive()) {
                ...
                switch (componentTypeName) {
                    case "long":
                        return join(conjunction, (long[]) array);
                    case "int":
                        return join(conjunction, (int[]) array);
                    case "short":
                        return join(conjunction, (short[]) array);
                    case "char":
                        return join(conjunction, (char[]) array);
                    case "byte":
                        return join(conjunction, (byte[]) array);
                    case "boolean":
                        return join(conjunction, (boolean[]) array);
                    case "float":
                ...
                return join(conjunction, (Object[]) array);
            }
        }
     ...
     * @return 原始类型数组
     */
    public static int[] unboxing(Integer... values) {
        if (null == values) {
            return null;
        }
        final int length = values.length;
     ...
     * @return 原始类型数组
     */
    public static long[] unboxing(Long... values) {
        if (null == values) {
            return null;
        }
        final int length = values.length;
     ...
     * @return 原始类型数组
     */
    public static char[] unboxing(Character... values) {
        if (null == values) {
            return null;
        }
        final int length = values.length;
     ...
     * @return 原始类型数组
     */
    public static byte[] unboxing(Byte... values) {
        if (null == values) {
            return null;
        }
        final int length = values.length;
     ...
     * @return 原始类型数组
     */
    public static short[] unboxing(Short... values) {
        if (null == values) {
            return null;
        }
        final int length = values.length;
     ...
     * @return 原始类型数组
     */
    public static float[] unboxing(Float... values) {
        if (null == values) {
            return null;
        }
        final int length = values.length;
     ...
     * @return 原始类型数组
     */
    public static double[] unboxing(Double... values) {
        if (null == values) {
            return null;
        }
        final int length = values.length;
     ...
     * @return 原始类型数组
     */
    public static boolean[] unboxing(Boolean... values) {
        if (null == values) {
            return null;
        }
        final int length = values.length;
