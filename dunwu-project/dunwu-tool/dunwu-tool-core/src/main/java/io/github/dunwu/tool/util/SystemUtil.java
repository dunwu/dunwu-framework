...
public class SystemUtil {
    ...
    /**
     * The prefix String for all MAC OS.
     */
    public static final String OS_NAME_MAC_PREFIX = "Mac OS X";
    ...
    public static final String BROWSER_MSIE_NAME_PREFIX = "MSIE";

    public static final String BROWSER_IE11_NAME_PREFIX = "rv:";

    public static final String BROWSER_FIREFOX_NAME_PREFIX = "Firefox";

    public static final String BROWSER_SOGOU_NAME_PREFIX = "MetaSr";

    public static final String BROWSER_CHROME_NAME_PREFIX = "Chrome";

    public static final String BROWSER_SAFARI_NAME_PREFIX = "Safari";
     ...
     * </p>
     * <p>
     * This value is initialized when the class is loaded. If {@link System#setProperty(String, String)} or {@link
    ...
    /**
     * <p>
     * The {@code java.awt.headless} System Property. The value of this property is the String {@code "true"} or {@code
     * "false"}.
     * </p>
     * <p>
     * Defaults to {@code null} if the runtime does not have security access to read this property or the property does
     ...
     * @since 2.0
     */
    public static final boolean IS_OS_MAC_OSX = getOsMatchesName(OS_NAME_MAC_PREFIX);
     ...
     * @since 3.4
     */
    public static final boolean IS_OS_MAC_OSX_CHEETAH = getOsMatches("10.0");
     ...
     * @since 3.4
     */
    public static final boolean IS_OS_MAC_OSX_PUMA = getOsMatches("10.1");
     ...
     * @since 3.4
     */
    public static final boolean IS_OS_MAC_OSX_JAGUAR = getOsMatches("10.2");
     ...
     * @since 3.4
     */
    public static final boolean IS_OS_MAC_OSX_PANTHER = getOsMatches("10.3");
     ...
     * @since 3.4
     */
    public static final boolean IS_OS_MAC_OSX_TIGER = getOsMatches("10.4");
     ...
     * @since 3.4
     */
    public static final boolean IS_OS_MAC_OSX_LEOPARD = getOsMatches("10.5");
     ...
     * @since 3.4
     */
    public static final boolean IS_OS_MAC_OSX_SNOW_LEOPARD = getOsMatches("10.6");
     ...
     * @since 3.4
     */
    public static final boolean IS_OS_MAC_OSX_LION = getOsMatches("10.7");
     ...
     * @since 3.4
     */
    public static final boolean IS_OS_MAC_OSX_MOUNTAIN_LION = getOsMatches("10.8");
     ...
     * @since 3.4
     */
    public static final boolean IS_OS_MAC_OSX_MAVERICKS = getOsMatches("10.9");
     ...
     * @since 3.4
     */
    public static final boolean IS_OS_MAC_OSX_YOSEMITE = getOsMatches("10.10");
     ...
     * @since 3.5
     */
    public static final boolean IS_OS_MAC_OSX_EL_CAPITAN = getOsMatches("10.11");
     ...
     * @return true if matches, or false if not or can't determine
     */
    private static boolean isOSMatch(final String osName, final String osVersion, final String osNamePrefix,
