 ...
 *
 * <p>
 * 32-bit Java port of https://code.google.com/p/smhasher/source/browse/trunk/MurmurHash3.cpp#94 <br> 128-bit Java port
 * of https://code.google.com/p/smhasher/source/browse/trunk/MurmurHash3.cpp#255
 * </p>
 *
...
public class MurmurHash implements Serializable {
    ...
    public static long[] hash128(CharSequence data) {
        return hash128(StringUtil.toBytes(data, DEFAULT_CHARSET));
    }
    ...
    public static int hash32(CharSequence data) {
        return hash32(StringUtil.toBytes(data, DEFAULT_CHARSET));
    }
    ...
    public static long hash64(CharSequence data) {
        return hash64(StringUtil.toBytes(data, DEFAULT_CHARSET));
    }
