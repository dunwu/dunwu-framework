 ...
 *
 * <p>
 * 通过以下静态方法获得此对象: <br> {@link #getInstance(String, TimeZone, Locale)}<br> {@link #getDateInstance(int, TimeZone,
 * Locale)}<br> {@link #getTimeInstance(int, TimeZone, Locale)}<br> {@link #getDateTimeInstance(int, int, TimeZone,
 * Locale)}
 * </p>
 * <p>
...
public class FastDateFormat extends Format implements DateParser, DatePrinter {
    ...
    /**
     * 获得 {@link FastDateFormat} 实例，使用默认地区<br> 支持缓存
     *
     * @param pattern 使用{@link java.text.SimpleDateFormat} 相同的日期格式
     * @return {@link FastDateFormat}
    ...
    public String toString() {
        return "FastDateFormat[" + printer.getPattern() + "," + printer.getLocale() + "," + printer.getTimeZone()
            .getID() + "]";
    }

    /**
     * 估算生成的日期字符串长度<br> 实际生成的字符串长度小于或等于此值
     *
     * @return 日期字符串长度
     */
