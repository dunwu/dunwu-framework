...
import io.github.dunwu.tool.codec.Base64;
...
import io.github.dunwu.tool.io.resource.Resource;
...
/**
 * 图片处理工具类：<br> 功能：缩放图像、切割图像、旋转、图像类型转换、彩色转黑白、文字水印、图片水印等 <br> 参考：http://blog.csdn.net/zhangzhikaixinya/article/details/8459400
 *
 * @author Looly
 */
public class ImgUtil {
    ...
    /**
     * {@link Image} 转 {@link BufferedImage}<br> 首先尝试强转，否则新建一个{@link BufferedImage}后重新绘制
     *
    ...
    public static void createImage(String str, Font font, Color backgroundColor, Color fontColor, ImageOutputStream out)
        ...
        Rectangle2D r =
            font.getStringBounds(str, new FontRenderContext(AffineTransform.getScaleInstance(1, 1), false, false));
    ...
    /**
     * {@link Image} 转 {@link RenderedImage}<br> 首先尝试强转，否则新建一个{@link BufferedImage}后重新绘制
     *
     * @param img {@link Image}
     * @return {@link BufferedImage}
     * @since 4.3.2
