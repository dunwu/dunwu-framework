<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column prop="storeType" label="存储服务类型"></el-table-column>
      <el-table-column prop="accessUrl" label="访问路径"></el-table-column>
      ...
      <el-table-column label="操作">
        <template slot-scope="scope">
          ...
          >
            ...
            <el-button plain size="mini" type="primary" slot="reference">
