...
@Api(tags = "TemplateConfig", description = "模板配置表 CRUD Controller")
public class TemplateConfigController {

    private final TemplateConfigService service;

    public TemplateConfigController(TemplateConfigService service) {
    ...
    public BaseResult saveOrUpdate(TemplateConfig entity) {
