...
/**
 * Interface for a primitive map that uses {@link long}s as keys.
...
public interface LongObjectMap<V> extends Map<Long, V> {
     ...
     * @return the value or {@link null} if the key was not found in the map.
     */
    V get(long key);
     ...
     * @return the previous value for this key or {@link null} if there was no previous mapping.
     */
     ...
     * @return the previous value for the key, or {@link null} if there was no mapping.
     */
    V remove(long key);
