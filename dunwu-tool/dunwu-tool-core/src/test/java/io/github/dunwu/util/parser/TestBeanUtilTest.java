...
class TestBeanUtilTest {
    ...
    void copyArrayObject() {
        ...
        StudentVO[] studentVoList = BeanUtil.mapArray(studentList, StudentVO.class);
    ...
    void copyListObject() {
        ...
        List<StudentVO> studentVoList = BeanUtil.mapList(studentList, StudentVO.class);
        assertThat(studentVoList).hasSize(3);
    ...
    void copySingleObject() {
        ...
        StudentVO studentVo = BeanUtil.map(student, StudentVO.class);
