package io.github.dunwu.tool.lang.test.bean;
...
public class UserInfoDict implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(id, that.id) && Objects.equals(realName, that.realName) && Objects.equals(photoPath,
            that.photoPath) && Objects.equals(examInfoDict, that.examInfoDict);
    }

    @Override
    public String toString() {
        return "UserInfoDict [id="
            + id
            + ", realName="
            + realName
            + ", photoPath="
