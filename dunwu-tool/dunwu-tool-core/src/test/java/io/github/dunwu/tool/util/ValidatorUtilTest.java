...
public class ValidatorUtilTest {
    ...
    public class CheckNumber {
        ...
        void isAllNumber() {
            Assertions.assertTrue(ValidatorUtil.isNumber("0123456789"));
            Assertions.assertFalse(ValidatorUtil.isNumber("abcdefghijklmnopqrstuvwxyz"));
            Assertions.assertFalse(ValidatorUtil.isNumber("How are you?"));
            Assertions.assertFalse(ValidatorUtil.isNumber("你奈我何"));
        }
