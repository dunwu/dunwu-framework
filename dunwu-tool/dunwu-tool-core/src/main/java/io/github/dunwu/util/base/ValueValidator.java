...
/**
 * 配值较验器 提供对值进行较验的api，并根据较验结果取值且返回
 */
public class ValueValidator {

    /**
     * 对目标值进行校验，并根据校验结果取值 <br> 使用示例(校验目标值是否大于0, 如果小于 0 则取值为 1) <br> ValueValidator.checkAndGet(-1, 1,
     * Validator.INTEGER_GT_ZERO_VALIDATOR)</br>
     *
     * @param value        校验值
