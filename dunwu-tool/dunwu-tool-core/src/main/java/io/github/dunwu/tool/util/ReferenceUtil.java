...
/**
 * 引用工具类，主要针对{@link Reference} 工具化封装<br> 主要封装包括：
 * <pre>
...
public class ReferenceUtil {
    ...
    public enum ReferenceType {
        ...
        WEAK,
        /**
         * 虚引用，在GC时发现虚引用对象，会将{@link PhantomReference}插入{@link ReferenceQueue}。 <br> 此时对象未被真正回收，要等到{@link
         * ReferenceQueue}被真正处理后才会被回收。
         */
        PHANTOM
    }
