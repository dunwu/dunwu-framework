...
/**
 * 读取带BOM头的流内容，<code>getCharset()</code>方法调用后会得到BOM头的编码，且会去除BOM头<br> BOM定义：http://www.unicode.org/unicode/faq/utf_bom.html<br>
 * <ul>
...
public class BOMInputStream extends InputStream {
    ...
    /**
     * Read-ahead four bytes and check for BOM marks. <br> Extra bytes are unread back to the stream, only BOM bytes are
     * skipped.
     *
