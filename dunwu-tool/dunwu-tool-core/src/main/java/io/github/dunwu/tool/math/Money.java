package io.github.dunwu.tool.math;
...
public class Money implements Serializable, Comparable<Money> {
     ...
     * <code>
     * assertEquals(999, Math.round(9.995 * 100)); assertEquals(1000, Math.round(999.5)); money = new Money((9.995));
     * assertEquals(999, money.getCent()); money = new Money(10.005); assertEquals(1001, money.getCent());
     * </code>
     *
