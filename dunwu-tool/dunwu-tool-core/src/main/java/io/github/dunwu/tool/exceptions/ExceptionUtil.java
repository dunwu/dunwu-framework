...
public class ExceptionUtil {
    ...
    /**
     * 获取异常链中最尾端的异常，即异常最早发生的异常对象。<br> 此方法通过调用{@link Throwable#getCause()} 直到没有cause为止，如果异常本身没有cause，返回异常本身<br>
     * 传入null返回也为null
     *
     * <p>
    ...
    /**
     * 获取异常链上所有异常的集合，如果{@link Throwable} 对象没有cause，返回只有一个节点的List<br> 如果传入null，返回空集合
     *
     * <p>
     * 此方法来自Apache-Commons-Lang3
     * </p>
    ...
    public static String stacktraceToOneLineString(Throwable throwable, int limit) {
        ...
        replaceCharToStrMap.put(CharUtil.CR, StringUtil.SPACE);
        replaceCharToStrMap.put(CharUtil.LF, StringUtil.SPACE);
        replaceCharToStrMap.put(CharUtil.TAB, StringUtil.SPACE);
    ...
    /**
     * 包装异常并重新抛出此异常<br> {@link RuntimeException} 和{@link Error} 直接抛出，其它检查异常包装为{@link UndeclaredThrowableException} 后抛出
     *
     * @param throwable 异常
     */
