...
/**
 * 可选默认值的基本类型的getter接口<br> 提供一个统一的接口定义返回不同类型的值（基本类型）<br> 如果值不存在或获取错误，返回默认值
 *
 * @author Looly
 */
public interface OptBasicTypeGetter<K> {
    ...
    /**
     * 获取字符串型属性值<br> 若获得的值为不可见字符，使用默认值
     *
     * @param key          属性名
     * @param defaultValue 默认值
     * @return 属性值，无对应值返回defaultValue
    ...
    /**
     * 获取int型属性值<br> 若获得的值为不可见字符，使用默认值
     *
     * @param key          属性名
     * @param defaultValue 默认值
     * @return 属性值，无对应值返回defaultValue
    ...
    /**
     * 获取short型属性值<br> 若获得的值为不可见字符，使用默认值
     *
     * @param key          属性名
     * @param defaultValue 默认值
     * @return 属性值，无对应值返回defaultValue
    ...
    /**
     * 获取boolean型属性值<br> 若获得的值为不可见字符，使用默认值
     *
     * @param key          属性名
     * @param defaultValue 默认值
     * @return 属性值，无对应值返回defaultValue
    ...
    /**
     * 获取Long型属性值<br> 若获得的值为不可见字符，使用默认值
     *
     * @param key          属性名
     * @param defaultValue 默认值
     * @return 属性值，无对应值返回defaultValue
    ...
    /**
     * 获取char型属性值<br> 若获得的值为不可见字符，使用默认值
     *
     * @param key          属性名
     * @param defaultValue 默认值
     * @return 属性值，无对应值返回defaultValue
    ...
    /**
     * 获取float型属性值<br> 若获得的值为不可见字符，使用默认值
     *
     * @param key          属性名
     * @param defaultValue 默认值
     * @return 属性值，无对应值返回defaultValue
    ...
    /**
     * 获取double型属性值<br> 若获得的值为不可见字符，使用默认值
     *
     * @param key          属性名
     * @param defaultValue 默认值
     * @return 属性值，无对应值返回defaultValue
    ...
    /**
     * 获取byte型属性值<br> 若获得的值为不可见字符，使用默认值
     *
     * @param key          属性名
     * @param defaultValue 默认值
     * @return 属性值，无对应值返回defaultValue
    ...
    /**
     * 获取BigDecimal型属性值<br> 若获得的值为不可见字符，使用默认值
     *
     * @param key          属性名
     * @param defaultValue 默认值
     * @return 属性值，无对应值返回defaultValue
    ...
    /**
     * 获取BigInteger型属性值<br> 若获得的值为不可见字符，使用默认值
     *
     * @param key          属性名
     * @param defaultValue 默认值
     * @return 属性值，无对应值返回defaultValue
