 ...
 */
public class ClassExtUtil extends ClassUtils {
    ...
    public static Set<Annotation> getAllAnnotations(final Class<?> cls) {
        List<Class<?>> allTypes = ClassExtUtil.getAllSuperclasses(cls);
        allTypes.addAll(ClassExtUtil.getAllInterfaces(cls));
        allTypes.add(cls);
    ...
    public static ClassLoader getDefaultClassLoader() {
        ...
        if (cl == null) {
            ...
            cl = ClassExtUtil.class.getClassLoader();
            if (cl == null) {
