...
public class MarkdownFormatHelper {
    ...
    public static void convertToGfm(String srcFilePath, String detFilePath) {
        ...
        for (String text : contents) {
            ...
            if (RegexUtil.matches(text, "date: \\d{4}/\\d{2}/\\d{2}")) {
    ...
    public static String convertImgTag(final String text) {
        // String newstr = RegexUtils.replaceAllMatchContent(text,
        // 	RegexUtils.REGEX_MARKDOWN_IMAGE_TAG, "![]");
        String newstr = text.replaceAll(RegexUtil.REGEX_MARKDOWN_IMAGE_TAG, "![]");
    ...
    private static List<String> addFrontMatter(String srcFilePath,
        ...
        String date = FileExtUtil.getFileCreateTimeString(srcFilePath, "yyyy-MM-dd");
