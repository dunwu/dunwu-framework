 ...
 */
public class DateExtUtil extends DateUtils {
    ...
    public static Date beginOfWeek(final Date date) {
        return DateUtils.truncate(
            DateUtils.addDays(date, 1 - DateExtUtil.getDayOfWeek(date)),
            Calendar.DATE);
    }
    ...
    public static Date nextWeek(final Date date) {
        return DateUtils.truncate(
            DateExtUtil.addDays(date, 8 - DateExtUtil.getDayOfWeek(date)),
            Calendar.DATE);
    }
