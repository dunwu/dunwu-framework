...
public class MathUtils {
	 ...
	 */
	public static int ceilingPowerOfTwo(final int value) {
	 ...
	 * @param value 必须为正数，否则抛出异常.
	 */
	public static long ceilingPowerOfTwo(final long value) {
	...
	/**
	 * 能控制rounding方向的int相除. jdk的'/'运算符，直接向下取整
	 */
	 ...
	 * @param value 必须为正数，否则抛出异常.
	 */
	public static int floorPowerOfTwo(final int value) {
	 ...
	 * @param value 必须为正数，否则抛出异常.
	 */
	public static long floorPowerOfTwo(final long value) {
