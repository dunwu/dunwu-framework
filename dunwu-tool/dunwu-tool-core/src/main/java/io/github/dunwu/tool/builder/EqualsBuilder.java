...
import io.github.dunwu.tool.lang.Pair;
...
public class EqualsBuilder implements Builder<Boolean> {
     ...
     * fields. This means that it will throw a security exception if run under a security manager, if the permissions
     * are not set up correctly. It is also not as efficient as testing explicitly. Non-primitive fields are compared
     * using
     * <code>equals()</code>.</p>
     *
     * <p>If the TestTransients parameter is set to <code>true</code>, transient
     * members will be tested, otherwise they are ignored, as they are likely derived fields, and not part of the value
