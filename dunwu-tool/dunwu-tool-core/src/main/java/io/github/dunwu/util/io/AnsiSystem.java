...
import io.github.dunwu.util.io.constant.AnsiBgColor;
import io.github.dunwu.util.io.constant.AnsiColor;
import io.github.dunwu.util.io.constant.AnsiSgr;
...
public class AnsiSystem {
    ...
    public static class AnsiConfig {
        ...
        public AnsiConfig(Color color, Color bgColor) {
            this.bold = false;
            this.italic = false;
            this.underline = false;
            this.slowBlink = false;
