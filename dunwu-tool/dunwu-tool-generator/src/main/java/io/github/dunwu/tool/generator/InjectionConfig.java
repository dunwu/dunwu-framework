...
import io.github.dunwu.tool.generator.config.IFileCreate;
...
public abstract class InjectionConfig {
    ...
    /**
     * 模板待渲染 Object Map 预处理<br> io.github.dunwu.tool.generator.engine.AbstractTemplateEngine 方法： getObjectMap 结果处理
     */
