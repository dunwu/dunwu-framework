...
import io.github.dunwu.tool.generator.config.po.LikeTable;
...
public class StrategyConfig {
    ...
    /**
     * 启用sql过滤 语法不能支持使用sql过滤表的话，可以考虑关闭此开关. 目前所知微软系需要关闭，其他数据库等待反馈，sql可能要改动一下才能支持，没数据库环境搞，请手动关闭使用内存过滤的方式。
     *
     * @since 3.3.1
     */
