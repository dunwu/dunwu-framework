...
class IpUtilsTest {
	...
	void getRegion() {
		String[] ips = { "117.136.45.132", "218.138.160.46", "183.206.167.143", "123.138.216.117", "180.98.66.165",
			...
			"221.205.169.151", "1.0.1.0", "218.93.179.246", "2.0.0.1", "118.28.8.8", "8.8.8.8", "61.155.110.90",
		...
		for (String ip : ips) {
			...
			AnsiSystem.BLUE.println(ip + " 所属完整行政单位：" + StringExtUtils.join(regionNames, ","));
			AnsiSystem.BLUE.println(ip + " 最小行政单位：" + StringExtUtils.join(IpUtils.getRegionName(ip)));
